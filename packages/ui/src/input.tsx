...
export const Input: React.FC<InputProps> = ({
  ...
  const inputClasses = `
    block w-full px-4 py-3 border-2 rounded-xl shadow-sm focus:outline-none focus:ring-4 focus:ring-opacity-30 text-base transition-all duration-200 bg-white dark:bg-gray-800
    ${error
