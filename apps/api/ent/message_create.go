...
func (mc *MessageCreate) SetFileURL(s string) *MessageCreate {
	mc.mutation.SetFileURL(s)
	return mc
}

// SetNillableFileURL sets the "file_url" field if the given value is not nil.
func (mc *MessageCreate) SetNillableFileURL(s *string) *MessageCreate {
	if s != nil {
		mc.SetFileURL(*s)
	}
	return mc
...
func (mc *MessageCreate) SetRoom(c *ChatRoom) *MessageCreate {
	return mc.SetRoomID(c.ID)
}
