...
func (mq *MessageQuery) QueryRoom() *ChatRoomQuery {
	query := (&ChatRoomClient{config: mq.config}).Query()
...
func (mq *MessageQuery) WithRoom(opts ...func(*ChatRoomQuery)) *MessageQuery {
	query := (&ChatRoomClient{config: mq.config}).Query()
...
func (mq *MessageQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Message, error) {
	...
	if query := mq.withRoom; query != nil {
		if err := mq.loadRoom(ctx, query, nodes, nil,
			func(n *Message, e *ChatRoom) { n.Edges.Room = e }); err != nil {
			return nil, err
		}
	}
...
func (mq *MessageQuery) loadRoom(ctx context.Context, query *ChatRoomQuery, nodes []*Message, init func(*Message), assign func(*Message, *ChatRoom)) error {
