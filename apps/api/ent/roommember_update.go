...
func (rmu *RoomMemberUpdate) SetRoomID(u uuid.UUID) *RoomMemberUpdate {
	rmu.mutation.SetRoomID(u)
	return rmu
}

// SetNillableRoomID sets the "room_id" field if the given value is not nil.
func (rmu *RoomMemberUpdate) SetNillableRoomID(u *uuid.UUID) *RoomMemberUpdate {
	if u != nil {
		rmu.SetRoomID(*u)
	}
	return rmu
...
func (rmu *RoomMemberUpdate) SetUserID(u uuid.UUID) *RoomMemberUpdate {
	rmu.mutation.SetUserID(u)
	return rmu
}

// SetNillableUserID sets the "user_id" field if the given value is not nil.
func (rmu *RoomMemberUpdate) SetNillableUserID(u *uuid.UUID) *RoomMemberUpdate {
	if u != nil {
		rmu.SetUserID(*u)
	}
	return rmu
...
func (rmu *RoomMemberUpdate) SetJoinedAt(t time.Time) *RoomMemberUpdate {
	rmu.mutation.SetJoinedAt(t)
	return rmu
}

// SetNillableJoinedAt sets the "joined_at" field if the given value is not nil.
func (rmu *RoomMemberUpdate) SetNillableJoinedAt(t *time.Time) *RoomMemberUpdate {
	if t != nil {
		rmu.SetJoinedAt(*t)
	}
	return rmu
...
func (rmu *RoomMemberUpdate) SetRoom(c *ChatRoom) *RoomMemberUpdate {
	return rmu.SetRoomID(c.ID)
}
...
func (rmu *RoomMemberUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	_spec := sqlgraph.NewUpdateSpec(roommember.Table, roommember.Columns, sqlgraph.NewFieldSpec(roommember.FieldID, field.TypeInt64))
...
// SetRoomID sets the "room_id" field.
func (rmuo *RoomMemberUpdateOne) SetRoomID(u uuid.UUID) *RoomMemberUpdateOne {
	rmuo.mutation.SetRoomID(u)
	return rmuo
}

// SetNillableRoomID sets the "room_id" field if the given value is not nil.
func (rmuo *RoomMemberUpdateOne) SetNillableRoomID(u *uuid.UUID) *RoomMemberUpdateOne {
	if u != nil {
		rmuo.SetRoomID(*u)
	}
	return rmuo
...
// SetUserID sets the "user_id" field.
func (rmuo *RoomMemberUpdateOne) SetUserID(u uuid.UUID) *RoomMemberUpdateOne {
	rmuo.mutation.SetUserID(u)
	return rmuo
}

// SetNillableUserID sets the "user_id" field if the given value is not nil.
func (rmuo *RoomMemberUpdateOne) SetNillableUserID(u *uuid.UUID) *RoomMemberUpdateOne {
	if u != nil {
		rmuo.SetUserID(*u)
	}
	return rmuo
...
// SetJoinedAt sets the "joined_at" field.
func (rmuo *RoomMemberUpdateOne) SetJoinedAt(t time.Time) *RoomMemberUpdateOne {
	rmuo.mutation.SetJoinedAt(t)
	return rmuo
}

// SetNillableJoinedAt sets the "joined_at" field if the given value is not nil.
func (rmuo *RoomMemberUpdateOne) SetNillableJoinedAt(t *time.Time) *RoomMemberUpdateOne {
	if t != nil {
		rmuo.SetJoinedAt(*t)
	}
	return rmuo
...
// SetRoom sets the "room" edge to the ChatRoom entity.
func (rmuo *RoomMemberUpdateOne) SetRoom(c *ChatRoom) *RoomMemberUpdateOne {
	return rmuo.SetRoomID(c.ID)
}
