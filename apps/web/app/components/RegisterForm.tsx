      ...
      <div className="max-w-lg w-full">
        <FormCard>
          ...
          <FormContainer onSubmit={handleSubmit(onSubmit)}>
            ...
            {error && (
              <div role="alert" className="bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 text-red-700 dark:text-red-400 px-4 py-4 rounded-xl flex items-center mt-6" data-testid="registration-error">
